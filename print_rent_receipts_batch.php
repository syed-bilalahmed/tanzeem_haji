...
<head>
    <meta charset="UTF-8">
    <title>کرایہ رسید بیچ پرنٹ (Batch Print)</title>
    ...
    <style>
        ...
        .signatures {
            display: flex;
            justify-content: space-between;
            margin-top: 20px; /* Pulls it up close to paragraph */
            padding-top: 15px; 
            padding-bottom: 5px; 
        }
        .sig-box {
...
<body>
    ...
    <div class="no-print mt-3 mb-1" style="width: 210mm; margin: 0 auto; text-align: right;">
        <a href="edit_rent_receipt.php?id=<?php echo $receipt['id']; ?>" class="btn btn-sm" style="background: #ffc107; color: #000;">ترمیم (Edit)</a>
