...
if (!has_permission('collections_edit')) { die("<div style='text-align:center; margin-top:50px; font-size:20px; font-family:Arial;'>Access Denied. You do not have edit permissions for collections.</div>"); }
include 'header.php'; 
?>
